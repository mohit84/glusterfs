...
posix_init(xlator_t *this)
{
    ...
    if (xattr_value[0] == '0') {
        ...
        for (i = 0; i < 256; i++) {
            ...
            drptr = opendir(dir_name);
            while ((dentry = readdir(drptr)) != NULL) {
                ...
                */
                if (dentry_len == 43) {
                    ...
                    */
                    ...
                    snprintf(gfid_path, sizeof(rename_gfid_path),
                             "%s/%02x/%02x/%s", dir_handle, rename_gfid[0],
                             rename_gfid[1], rename_gfid_str);
